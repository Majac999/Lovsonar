...
# -*- coding: utf-8 -*-
"""
LovSonar v3.1 - Strategisk Fremtidsovervåking for Varehandel
=============================================================
Fikset: Fjernet DiBK RSS (404), korrigert Lovdata-URLer
"""
...
USER_AGENT = "LovSonar/3.1 (Strategisk Pilot for Varehandel)"
...
REGULATIONS_TO_MONITOR = {
    "Byggevareforskriften (DOK)": "https://lovdata.no/dokument/SF/forskrift/2013-12-17-1579",
...
def main():
    logger.info("=" * 60)
    logger.info("LovSonar v3.1 - Strategisk Fremtidsovervåking")
    logger.info("=" * 60)
